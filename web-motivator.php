    ...
    <body>    
        ...
        <div class="container recommendation_container"> 
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center recommendation_spot_title text-danger"><b><?= $data['name'] ?></b></h2>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        ?>
                            <img src="uploads/<?=$data['photo']?>" alt="User photo" class="rounded-circle img-fluid mx-auto d-block profile-img img-thumbnail" height="85px" width="85px">							
                        <?php 
                            }else{
                        ?>
                        ...
                        <div class="col-md-2">
                            <a href="service-request.php?s=<?= $data['id'] ?>" class="btn btn-warning text-white">Send Service Request</a>
                        </div>
                    </div>
                    <br>
